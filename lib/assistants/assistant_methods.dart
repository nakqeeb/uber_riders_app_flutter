...
class AssistantMethods {
  ...
  static Future<String> searchAddressForGeographicCoOrdinates(
    ...
    // the string 'Error Occurred, Failed. No Response.' is from catch block at RequestAssistant class
  ...
  static Future<DirectionDetailsInfo?>
    ...
    directionDetailsInfo.durationValue = responseDirectionApi['routes'][0]
        ['legs'][0]['duration']['value']; // durationValue is in seconds
  ...
  static double calculateFareAmountFromOriginToDestination(
    ...
    // in case of local currency Ex: 1USD = 75RS
    // double localCurrencyTotalFareAmount = totalFareAmount * 75;

    return double.parse(totalFareAmount.toStringAsFixed(1)); // Ex: 14.2
  }
  ...
  static void readTripsKeysForOnlineUser(context) {
    FirebaseDatabase.instance
      ...
      if (snap.snapshot.value != null) {
        ...
        //share trips keys with Provider (ride request ids)
...
/* {
    "notification":{
      ...
      "data": {
          ...
          "id": "1",
          "status": "done",
          "rideRequestId": "-N1TMXaievfiA-ZXZGfn"
      },
      "to": "dJ9XI9WiTvWGMAi3EB_V3X:APA91bHVVini2GXMvd-KEFDtS2yfzQZ0QXJ7tAedtY3OzbKdwiRPbFgfP35fHumYFpYfvsIX0f7cOMSwYttvWoS9x4gRG_9BC82-qxxO6HSmclPLfsqF50-_uhcC95FXL8pIcuz3dLWZ"
} */